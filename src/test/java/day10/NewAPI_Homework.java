...
public class NewAPI_Homework {
    ...
    public void testGetAllArticleAuthor(){
        ...
        List<String> allAuthorsNoNull = jp.getList("articles.findAll {it.source.id != null && it.author != null}.author");
        System.out.println("allAuthorsNoNull = " + allAuthorsNoNull);
        System.out.println("allAuthorsNoNull.size() = " + allAuthorsNoNull.size());
